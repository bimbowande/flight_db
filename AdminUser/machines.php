...
if(isset($_GET['value'])){
    $value = $_GET['value'];
    $query = $allFlights->deleteMachineItem($value);
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="relative overflow-x-auto width_adjust">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            ?>
                ...
                <td>
                    <td>
                <a href='#' class='see_more'><button confirm="" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Update</button>
                    </a>
                   
                    <a href="<? echo $_SERVER['PHP_SELF']."?value=".$key['id'] ?>" class='see_more'>
